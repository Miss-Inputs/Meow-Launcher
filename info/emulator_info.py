...
emulators = {
	...
	'MAME (Memorex VIS)': MameSystem(command_lines.mame_command_line('vis', 'cdrom'), mame_cdrom_formats),
	...
	'MAME (Squale)': MameSystem(command_lines.mame_command_line('squale', 'cart', has_keyboard=True), ['bin']),
