...
systems = {
	...
	'Apple II': System('apple2', ['apple2', 'apple2_cass', 'apple2_flop_orig'], ['MAME (Apple II)'], {MediaType.Floppy: ['do', 'dsk', 'po', 'nib', 'woz'], MediaType.Tape: ['wav']}, {'use_iie': SpecificConfigValue(ConfigValueType.Bool, True, 'Use Apple IIe driver instead of II+')}),
