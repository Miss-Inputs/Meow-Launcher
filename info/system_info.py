...
systems = {
	...
	'Apple II': System('apple2', ['apple2', 'apple2_cass'], ['MAME (Apple II)'], {MediaType.Floppy: ['do', 'dsk', 'po', 'nib', 'woz'], MediaType.Tape: ['wav']}, {'use_iie': SpecificConfigValue(ConfigValueType.Bool, True, 'Use Apple IIe driver instead of II+')}),
...
systems.update({
	...
	'Amstrad CPC': UnsupportedSystem('cpc464', ['cpc_cass', 'cpc_flop'], [], {MediaType.Snapshot: ['sna'], MediaType.Tape: ['wav', 'cdt'], MediaType.Floppy: mmame_floppy_formats}),
	...
	'Memotech MTX': UnsupportedSystem('mtx512', ['mtx_cart', 'mtx_cass', 'mtx_rom'], []),
