...
emulators: dict[str, StandardEmulator] = {
...
libretro_cores = {core.name + ' (libretro)': core for core in _libretro_cores}
...
all_emulators: dict[str, Union[Emulator, LibretroFrontend]] = {}
