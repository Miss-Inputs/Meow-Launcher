...
_standalone_emulators: Collection[StandardEmulator] = [
	...
	StandardEmulator('DuckStation', EmulatorStatus.Good, 'duckstation-qt', command_lines.duckstation, ['bin', 'img', 'cue', 'chd', 'exe', 'm3u', 'iso'], [], {
	...
	MAMEDriver('Apple II', EmulatorStatus.Good, command_lines.mame_apple_ii, mame_floppy_formats + ['nib', 'do', 'po', 'woz']), #nib support only >= 0.229
	MAMEDriver('Apple IIgs', EmulatorStatus.Good, simple_mame_driver('apple2gsr1', 'flop3', {'gameio': 'joy'}, has_keyboard=True), mame_floppy_formats + ['2mg', '2img', 'dc', 'woz']),
	...
	MAMEDriver('Apple III', EmulatorStatus.Good, simple_mame_driver('apple3', 'flop1', has_keyboard=True), mame_floppy_formats + ['do', 'po']),
	...
	MAMEDriver('Coleco Adam', EmulatorStatus.Good, command_lines.mame_coleco_adam, ['wav', 'ddp'] + mame_floppy_formats),
	...
	MAMEDriver('IBM PCjr', EmulatorStatus.Good, command_lines.mame_ibm_pcjr, mame_floppy_formats + ['img', 'bin', 'jrc']),
	...
	MAMEDriver('MSX', EmulatorStatus.Good, command_lines.mame_msx1, generic_cart_extensions + mame_floppy_formats),
	MAMEDriver('MSX2', EmulatorStatus.Good, command_lines.mame_msx2, generic_cart_extensions + mame_floppy_formats),
	MAMEDriver('MSX2+', EmulatorStatus.Good, command_lines.mame_msx2plus, generic_cart_extensions + mame_floppy_formats),
	...
	MAMEDriver('SG-1000', EmulatorStatus.Good, command_lines.mame_sg1000, ['bin', 'sg', 'sc', 'sf', 'sf7'] + mame_floppy_formats),
	MAMEDriver('Sharp X1', EmulatorStatus.Good, simple_mame_driver('x1turbo40', 'flop1', has_keyboard=True), mame_floppy_formats + ['2d']),
	...
	MAMEDriver('Sharp X68000', EmulatorStatus.Good, command_lines.mame_sharp_x68000, mame_floppy_formats + ['xdf', 'hdm', '2hd', 'dim', 'm3u']),
	...
	MAMEDriver('Thomson MO5', EmulatorStatus.Good, simple_mame_driver('mo5', 'flop1', has_keyboard=True), ['fd', 'sap'] + mame_floppy_formats),
	...
	MAMEDriver('ZX Spectrum', EmulatorStatus.Good, command_lines.mame_zx_spectrum, ['ach', 'frz', 'plusd', 'prg', 'sem', 'sit', 'sna', 'snp', 'snx', 'sp', 'z80', 'zx', 'bin', 'rom', 'raw', 'scr'] + mame_floppy_formats),
	...
	MAMEDriver('FM Towns', EmulatorStatus.ExperimentalButSeemsOkay, command_lines.mame_fm_towns, mame_cdrom_formats + mame_floppy_formats + ['bin']),
	MAMEDriver('FM Towns Marty', EmulatorStatus.ExperimentalButSeemsOkay, command_lines.mame_fm_towns_marty, mame_cdrom_formats + mame_floppy_formats + ['bin']),
	...
	MAMEDriver('Microbee', EmulatorStatus.ExperimentalButSeemsOkay, command_lines.mame_microbee, ['mwb', 'com', 'bee'] + mame_floppy_formats),
	...
	MAMEDriver('Sharp MZ-2000', EmulatorStatus.ExperimentalButSeemsOkay, simple_mame_driver('mz2200', 'flop1', has_keyboard=True), mame_floppy_formats + ['2d']),
	...
	MAMEDriver('Sony SMC-777', EmulatorStatus.ExperimentalButSeemsOkay, simple_mame_driver('smc777', 'flop1', has_keyboard=True), mame_floppy_formats + ['1dd']),
	...
	MAMEDriver('IBM PC', EmulatorStatus.Janky, simple_mame_driver('ibm5150', 'flop1', {'isa5': 'sblaster1_5'}, has_keyboard=True), mame_floppy_formats + ['img']),
