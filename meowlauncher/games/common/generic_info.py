		...
		if tag.startswith('[t '):
			...
			if trainer_description.startswith('+'):
				if ' ' in trainer_description:
					...
					game_info.specific_info.setdefault('Bad Dump', set()).add(f'{number_of_trainers} Trainers')
					game_info.specific_info['Trained By'] = trained_by
				else:
					game_info.specific_info.setdefault('Bad Dump', set()).add(f'{trainer_description} Trainers')
			else:
		...
		if tag.lower().startswith('[req '):
			...
			if existing_requirement:
				if requirement not in existing_requirement:
					game_info.specific_info['Requirement'] = f'{existing_requirement}, {requirement}'
			else:
