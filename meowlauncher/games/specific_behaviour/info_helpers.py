"""Dispatches to whatever module in specific_behaviour is appropriate, depending on platform
...
from .amiga import add_amiga_info_from_filename_tags, add_amiga_software_list_info
...
from .master_system import add_sms_gg_rom_file_info, add_sms_gg_software_list_info
from .megadrive import add_megadrive_custom_info, find_equivalent_mega_drive_arcade
from .misc_platforms import (
	add_colecovision_software_info,
	add_ibm_pcjr_custom_info,
	add_pet_info_from_filename_tags,
	add_vic10_custom_info,
	add_vic20_custom_info,
...
from .snes import (
	add_snes_rom_header_info,
	add_snes_software_list_metadata,
...
from .static_platform_info import (
	...
	add_arcadia_info,
	add_astrocade_info,
	add_bandai_sv8000_info,
	add_bbc_bridge_companion_info,
	add_benesse_v2_info,
	add_casio_pv1000_info,
	add_cd32_info,
	...
	add_vc4000_info,
	add_vectrex_info,
	add_virtual_boy_info,
	add_vsmile_babby_info,
	add_vsmile_info,
	add_vz200_info,
...
from .zx_spectrum import (
	add_speccy_filename_tags_info,
	add_speccy_rom_info,
