...
_standard_controller.face_buttons = (
	6  # A B C X Y Z #yeah I had to count them because I have 0 brain cells sorry
)
...
def _parse_peripherals(
	game_info: 'GameInfo', peripherals: str, rom_path_for_warning: Any = None
) -> None:
