...
def add_entex_adventure_vision_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_game_pocket_computer_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_gamate_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_casio_pv1000_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 2
	metadata.input_info.add_option(builtin_gamepad)
...
def add_mega_duck_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 2
	metadata.input_info.add_option(builtin_gamepad)
...
def add_watara_supervision_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 2
	metadata.input_info.add_option(builtin_gamepad)
...
def add_arcadia_info(metadata: 'Metadata') -> None:
...
def add_astrocade_info(metadata: 'Metadata') -> None:
...
def add_vc4000_info(metadata: 'Metadata') -> None:
...
def add_hartung_game_master_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 2
	metadata.input_info.add_option(builtin_gamepad)

def add_vz200_info(metadata: 'Metadata') -> None:
	keyboard = Keyboard()
	keyboard.keys = 45
	#There are in theory joysticks, but they don't seem to ever be a thing
	metadata.input_info.add_option(keyboard)

def add_bandai_sv8000_info(metadata: 'Metadata') -> None:
...
def add_nichibutsu_my_vision_info(metadata: 'Metadata') -> None:
...
def add_bbc_bridge_companion_info(metadata: 'Metadata') -> None:
...
def add_cd32_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 4
...
def add_neogeo_cd_info(metadata: 'Metadata') -> None:
...
def add_juicebox_info(metadata: 'Metadata') -> None:
...
def add_super_cassette_vision_info(metadata: 'Metadata') -> None:
...
def add_super_acan_info(metadata: 'Metadata') -> None:
...
def add_vsmile_info(metadata: 'Metadata') -> None:
	controller = NormalController()
...
def add_gba_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 2 #A B
...
def add_benesse_v2_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 3 #I don't know what they're called
	metadata.input_info.add_option(builtin_gamepad)

def add_wonderswan_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_gamecom_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_vectrex_info(metadata: 'Metadata') -> None:
...
def add_ngp_info(metadata: 'Metadata') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_virtual_boy_info(metadata: 'Metadata') -> None:	
	gamepad = NormalController()
...
def add_3ds_info(metadata: 'Metadata') -> None:
