...
from meowlauncher.input_info import (
	CombinedController,
	Keyboard,
	Keypad,
	NormalController,
...
def add_game_gear_info(metadata: 'GameInfo') -> None:
...
def add_entex_adventure_vision_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_game_pocket_computer_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_gamate_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_casio_pv1000_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 2
	metadata.input_info.add_option(builtin_gamepad)
...
def add_mega_duck_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 2
	metadata.input_info.add_option(builtin_gamepad)
...
def add_watara_supervision_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 2
	metadata.input_info.add_option(builtin_gamepad)
...
def add_arcadia_info(metadata: 'GameInfo') -> None:
	...
	stick.analog_sticks = (
		1  # According to MAME it's an analog stick but everywhere else suggests it's just digital?
	)
...
def add_astrocade_info(metadata: 'GameInfo') -> None:
...
def add_vc4000_info(metadata: 'GameInfo') -> None:
...
def add_hartung_game_master_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 2
	metadata.input_info.add_option(builtin_gamepad)
...
def add_vz200_info(metadata: 'GameInfo') -> None:
	keyboard = Keyboard()
	keyboard.keys = 45
...
def add_bandai_sv8000_info(metadata: 'GameInfo') -> None:
...
def add_nichibutsu_my_vision_info(metadata: 'GameInfo') -> None:
...
def add_bbc_bridge_companion_info(metadata: 'GameInfo') -> None:
	buttons = NormalController()
	buttons.face_buttons = (
		10  # According to the MAME driver, I'm too lazy to look at pictures of the thing
	)
	metadata.input_info.add_option(buttons)
...
def add_cd32_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 4
...
def add_neogeo_cd_info(metadata: 'GameInfo') -> None:
...
def add_juicebox_info(metadata: 'GameInfo') -> None:
...
def add_super_cassette_vision_info(metadata: 'GameInfo') -> None:
...
def add_super_acan_info(metadata: 'GameInfo') -> None:
...
def add_vsmile_info(metadata: 'GameInfo') -> None:
	controller = NormalController()
...
def add_vsmile_babby_info(metadata: 'GameInfo') -> None:
	controller = NormalController()
...
def add_pokemini_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
...
def add_gba_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = 2  # A B
...
def add_benesse_v2_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_wonderswan_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_gamecom_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_vectrex_info(metadata: 'GameInfo') -> None:
...
def add_ngp_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
...
def add_virtual_boy_info(metadata: 'GameInfo') -> None:
	gamepad = NormalController()
...
def add_3ds_info(metadata: 'GameInfo') -> None:
...
def add_lynx_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.face_buttons = (
		4  # Option 1, Option 2, A, B; these are flipped so you might think there's 8
	)
	metadata.input_info.add_option(builtin_gamepad)


def add_psp_info(metadata: 'GameInfo') -> None:
	builtin_gamepad = NormalController()
	builtin_gamepad.dpads = 1
	builtin_gamepad.analog_sticks = 1
	builtin_gamepad.face_buttons = (
		4  # also Start, Select, which I don't count because I just never have I guess
	)
	builtin_gamepad.shoulder_buttons = 2
	metadata.input_info.add_option(builtin_gamepad)
