...
regions = [
	...
	Region('Ireland', 'IE', TVSystem.PAL, 'English (British)'), #Hopefully that is a safe assumption to make about software that was released there…
	...
	Region('Pakistan', 'PK', TVSystem.PAL, 'Urdu'),
